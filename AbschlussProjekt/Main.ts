...
class Game {
    ...
    public constructor() {
        ...
        //console.log(Physics.AABBVsAABB(box1, box2));
        //console.log(Physics.AABBVsAABB(box2, box3));
        //console.log(Physics.AABBVsAABB(box3, box1));
        ...
        console.log(Physics.CircleVsCircle(c1, c2));
        console.log(Physics.CircleVsCircle(c2, c3));
        console.log(Physics.CircleVsCircle(c3, c1));
    }
}
